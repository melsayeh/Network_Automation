...
switch_ip_file = '\home\swicthes\ip_list'
result_file = '\home\switches\inventory.csv'
separator = ';'
result_list = list()
...
for switch_ip in switch_ip_list:
    ...
    if telnet_test_result == 'OK':
        ...
        if str(current_session_output) == 'SIMPLE PASSWORD':
            ...
            current_session_output = telnet_send_username_password(current_host, local_username, local_password,
                                                                   current_session_output)
    ...
    if authenticated and privmode:
        ...
        result_tuple = (
        mgmt_ip_got, hostname_got, ios_ver_got, ios_image_name_got, model_got, ssh_test_result, telnet_test_result,
        radius_status)
        print('*** Data to save:')
        print(result_tuple)
